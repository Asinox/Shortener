                ...
                <div className='col'>
                    <div className='row'>
                        <div className="col pr-0">          
                            <input ref="inputText" type ='text' autoComplete="false" name="url" className="form-control" placeholder={this.props.placeHolder} value={this.state.longUrl} onChange={this.getLongUrl.bind(this)} onKeyPress={this.shortUrl.bind(this)}/>
